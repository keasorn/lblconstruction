...
@section("content")
    <div class="row clearfix">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                <div class="header">
                    <a href="{{route("recommend.create")}}" class="btn btn-info right">
                ...
                <div class="body">
                    <div class="table-responsive">
                        <table class="table table-hover dashboard-recommend-infos">
                            <thead>
                            <tr>
                                <th>No</th>
                                <th>Logo</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form class="row" method="post"
                                              action="{{ route('recommend.destroy', [$row->id]) }}"
                                              onsubmit="return confirm('Do you want to delete?')">
                                            @method('delete')
                                            <input type="hidden" required name="_token" value="{{ csrf_token() }}">
                                            <a href="{{ route('recommend.edit', $row->id) }}"
