                ...
                <div class="primary-banner-text">
                    ...
                    <div class="col-sm-3 cus_contact_menu" style="color: #fff; font-size: 22px;">
                        ...
                        <div class="col-sm-10 cus_contact_menu_sub"
                            ...
                            sales@lbl-group.com<br/> Careers: jobs@lbl-group.com<br/> Suppliers:
                            purchasing@lbl-group.com
                        </div>
                    </div>
    ...
    <div class="container-fluid">
        ...
        <div class="container cus_journey_sub_container">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-4">
                            ...
                            <p class="cus_journey_sub_p"
                               style="padding-top: 20px; padding-right: 50px; font-size: 18px; font-weight: 100;">
                                Our design and build approach seeks to create comprehensive solutions based on the close
                                and continuous cooperation between the client and our experienced design teams. Whether
                                the requested work is a basic conceptual design, a fully
                            </p>
                        </div>
                        <div class="col-xs-12 col-sm-4 col-md-4">
                            <p class="cus_journey_sub_p"
                               style="padding-top: 40px; padding-right: 50px; font-size: 18px; font-weight: 100;">
                                detailed design or the entire delivery of the project, LBL uses its internal resources
                                from start to finish. The design and build approach thus gives our clients a single
                                point of contact fro both the design and construction phases of any project.
                            </p>
                        </div>
                        <div class="col-xs-12 col-sm-4 col-md-4">
                            <b>BUILD</b>
                            <p class="cus_journey_sub_p"
                               style="padding-top: 20px; padding-right: 50px; font-size: 18px; font-weight: 100;">
                                The heart of each project is its construction.<br/> With our technical expertise and
                                experiences we conduct the operations with our professional teams, our special equipment
                                and the management of resources to deliver
                                creative and cost-efficient solutions that are fully compliant with the specific
            ...
            <div class="col-xs-12" style="text-align:center; padding: 60px 0px 60px 0px;">
                <div class="cus_journey_sub_title" style="font-size: 40px; font-weight: 100; color: #FFF;">"A Journey to
                    Cambodia 3.0"
                </div>
            </div>
        </div>
    ...
    <div class="containet-fluid" style="background:#19253e;">
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6 project_box" style="position: relative;">
                <img src="images/p1.png" class="h_grayscale h_grayscale_first"
            ...
            <div class="col-xs-12 col-sm-6 col-md-6" style="position: relative;">
                <div class="row">
                    <div class="col-xs-12 project_box">
                        <img src="images/p2.png" class="h_grayscale"
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 project_box" style="position: relative;">
                        <img src="images/p3.png" class="h_grayscale h_grayscale_3 cus_gallery_text_second"
                             style="max-width: 100%; max-height: 100%; display: block;height: 416px;width: 100%;padding-bottom:2px"/>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6 project_box" style="position: relative;">
                <img src="images/p4.png" class="h_grayscale h_grayscale_4"
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 project_box" style="position: relative;">
                <img src="images/p5.png" class="h_grayscale h_grayscale_5"
                     style="max-width: 100%; max-height: 100%; display: block;padding-bottom:2px"/>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 project_box" style="position: relative;">
                        <img src="images/p6.png" class="h_grayscale h_grayscale_6"
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 project_box" style=" position: relative;">
                        <img src="images/p7.png" class="h_grayscale h_grayscale_6"
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 project_box" style="position: relative;">
                <img src="images/p8.png" class="h_grayscale"
        ...
        <div class="container footer">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6" style="padding:50px 0px;">
                    ...
                    <div style="font-size:14px; font-weight: 100;  color: #3f62af;">Credibility and confidence gained
                        through completion
                    </div>

                    <div class="scroll_2" id="style-4" style="height: 500px; overflow-y: scroll; margin-top: 30px;">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6 cus_footer_logo_list"
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6 cus_a_contruction"
                    ...
                    A Contruction, Architecture,<br/> Refurbishment, Public work,<br/> Engineering and Development<br/>
                    company in Cambodia.
                </div>
                <div class="col-xs-12 col-sm-3 col-md-3" style="color:#3f62af; text-align:left;">
                    ...
                    <div class="cus_a_contruction_sub" style="font-size: 14px; font-weight:100; line-height: 25px;">
                        43 Sihanouk boulevard,<br/> Phnom Penh BP 609<br/> (855) 23 215 296<br/> Sales:
                        sales@lbl-group.com<br/> Careers: jobs@lbl-group.com<br/> Suppliers: purchasing@lbl-group.com
                    </div>
                </div>
                        ...
                        <nav>
                            <ul class="single-page-nav single_page_nav" style="list-style: none; text-align: right;">
                                <li><a href="#primary-banner" class="cus_a_contruction"
                                       style="color: #3f62af !important;font-weight:300; font-size:25px;">Home</a></li>
                                <li><a href="#about-us" class="cus_a_contruction"
                                       style="color: #3f62af !important;font-weight:300; font-size:25px;">About Us</a>
                                </li>
                                ...
                                <li><a href="#they-recommend-us" class="cus_a_contruction"
                                       style="color: #3f62af !important;font-weight:300; font-size:25px;">They Recommend
                                        Us</a></li>
