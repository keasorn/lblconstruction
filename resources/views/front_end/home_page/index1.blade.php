        ...
        <div class="container-fluid">
            ...
            <div class="container cus_journey_sub_container">
                            ...
                            <div class="col-xs-12 col-sm-4 col-md-4">
                                ...
                                <p class="cus_journey_sub_p"
                                   style="padding-top: 20px; padding-right: 50px; font-size: 18px; font-weight: 100;">
                                    Our design and build approach seeks to create comprehensive solutions based on the
                                    close and continuous cooperation between the client and our experienced design
                                    teams. Whether the requested work is a basic conceptual design, a fully
                                </p>
                            </div>
                            <div class="col-xs-12 col-sm-4 col-md-4">
                                <p class="cus_journey_sub_p"
                                   style="padding-top: 40px; padding-right: 50px; font-size: 18px; font-weight: 100;">
                                    detailed design or the entire delivery of the project, LBL uses its internal
                                    resources from start to finish. The design and build approach thus gives our clients
                                    a single point of contact fro both the design and construction phases of any
                                    project.
                                </p>
                            </div>
                            <div class="col-xs-12 col-sm-4 col-md-4">
                                ...
                                <p class="cus_journey_sub_p"
                                   style="padding-top: 20px; padding-right: 50px; font-size: 18px; font-weight: 100;">
                                    ...
                                    experiences we conduct the operations with our professional teams, our special
                                    equipment and the management of resources to deliver
                ...
                <div class="col-xs-12" style="text-align:center; padding: 60px 0px 60px 0px;">
                    <div class="cus_journey_sub_title" style="font-size: 40px; font-weight: 100; color: #FFF;">"A
                        Journey to Cambodia 3.0"
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 cus_gallery_text_first"
                            ...
                            <div class="cus_gallery_text cus_gallery_text_second"
                                ...
                                <div class="cus_gallery_text_thirt"
                                    ...
                                    <p>Moving onward, LBL will continue to provide excellence in our service and top
                                        quality
                                        results for an ever-demanding construction sector, as it pursues its expansion
                                        in
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12" style="text-align:center; padding: 60px 0px 40px 0px;">
                        <div style="font-size: 40px; font-weight: 100;" class="text-blue">They recommend us</div>
                    ...
                    <div class="col-sx-12">
                        ...
                        <center>
                            <button type="submit" class="btn-default"
                                    style="padding: 3px 40px 0 40px;margin-top:50px;margin-bottom:90px"
                                    data-toggle="modal"
    ...
    <section id="footer">
        <div class="container-fluid">
            ...
            <div class="container footer">
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 cus_footer_logo"
