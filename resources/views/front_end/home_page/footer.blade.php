        ...
        <div class="container footer">
            ...
            <div class="row" style="padding:30px 0px;">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 main_cus_social_icon"
                    ...
                    <a href="{{$header->facebook}}" class="social_icon cus_social_icon1"
                       style="float: left; margin-right: 30px;"><img
                                src="images/Icon awesome-facebook-f.svg"/></a>
                    <a href="{{$header->instagram}}" class="social_icon cus_social_icon2"
                       style="float: left; margin-right: 30px;"><img
