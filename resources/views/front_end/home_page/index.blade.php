        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="background bg-video cus_header">
                    <div class="layer darken-pseudo cus_main_image" style="background-image: url({{compress('images/home_bg.png')}});">
            ...
            <div id="menu" class="row" style="position: absolute; width: 100%; top: 0; left: -7px; display: none;">
                ...
                <div class="background bg-video background-bg-video">
                    <div class="layer darken-pseudo" style="background-image: url({{compress('images/menu_bg.png')}});"></div>
                </div>
                <!-- / Slider -->
            </div>
        </div>
    ...
    <div class="containet-fluid" style="background:#19253e;">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-6 project_box" style="position: relative;">
                        <img src="{{compress('images/p6.png')}}" class="h_grayscale h_grayscale_6"
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 project_box" style=" position: relative;">
                        <img src="{{compress('images/p4.png')}}" class="h_grayscale h_grayscale_6"
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 project_box" style="position: relative;">
                <img src="{{compress('images/p8.png')}}" class="h_grayscale"
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-3 col-md-3" style="color:#3f62af; text-align:left;">
                    ...
                    <div class="cus_a_contruction_sub" style="font-size: 14px; font-weight:100; line-height: 25px;">
                        43 Sihanouk boulevard,<br/> Phnom Penh BP 609<br/> (855) 23 215 296<br/> Sales: sales@lbl-group
